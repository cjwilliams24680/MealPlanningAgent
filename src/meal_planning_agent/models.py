...
gemini_client = AsyncOpenAI(base_url=GEMINI_BASE_URL, api_key=assertKeyExists("GOOGLE_API_KEY"))
gemini_model = OpenAIChatCompletionsModel(model="gemini-3.6-flash", openai_client=gemini_client)

GROK_BASE_URL = "https://api.x.ai/v1"
grok_client = AsyncOpenAI(base_url=GROK_BASE_URL, api_key=assertKeyExists("GROK_API_KEY"))
